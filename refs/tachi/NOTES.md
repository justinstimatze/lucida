...
## Incoming frames (re-assigned from refs/rocinante, curation 2026-06-09)
...
registry terminal) — re-assessment: these are mars-red/tachi-era surfaces.
Filenames kept for provenance.

## Sources

- `NqDcnwrsq6U` — **the Donnager (MCRN flagship), S1.** Timestamp-pinned 2026-05-29 with
...
- `Jo95Y5BBHdA` @0:02–0:06 — supplement (rs_*.png). Note: "mostly got this with the ring
...
| `Jo95Y5BBHdA` | https://www.youtube.com/watch?v=Jo95Y5BBHdA | `0:02-0:06 (ring station attack — already covered earlier)` | Minor supplement; note: "actually we got most of this with the ring station attack earlier" |
